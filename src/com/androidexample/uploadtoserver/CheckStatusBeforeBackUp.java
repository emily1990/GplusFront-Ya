...
public class CheckStatusBeforeBackUp extends Activity{
  ...
  //  final String checkPath = "/data/local/tmp/";
  ...
  checkBackUpstatusUri = "http://160.39.205.142:8080/gppcloudbackend/get_backup_info?user_id=Mickey";
    ...
    uploadButton.setOnClickListener(new OnClickListener() {            
        ...
        public void onClick(View v) {
            ...
            dialog = ProgressDialog.show(CheckStatusBeforeBackUp.this, "", "Check backed up...", true);
    	     ...
    	     if (response.getStatusLine().getStatusCode() == 200) {
    	    	 runOnUiThread(new Runnable() {
                     public void run() {
                         ...
                         Toast.makeText(CheckStatusBeforeBackUp.this, "check status finished.", 
         ...
         */      
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    Toast.makeText(CheckStatusBeforeBackUp.this, "Got Exception : see logcat ", 
                            Toast.LENGTH_SHORT).show();
                }
            });
